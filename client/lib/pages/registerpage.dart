...
class RegisterPage extends StatelessWidget {
  RegisterPage(this._eventBus, {super.key});
      ...
      body: Column(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              "You may only be invited to use this app by an existing user!",
          ...
          ElevatedButton(
            onPressed: () {
              if (usernameController.text.isEmpty) {
                Errors.flashError("Register Error", "Username field is blank!");
                return;
              }
              if (passwordController.text.isEmpty) {
                Errors.flashError("Register Error", "Password field is blank!");
                return;
              }
              _eventBus.sendAuth(
          ...
          Padding(
            ...
            child: InkWell(
              onTap: () {
                NavigatorTool.push(LoginPage(_eventBus));
              },
              child: const Text(
